...
df = CSV.read("/home/cmarinelli/Simulations/Parameters/parameters_vax5.csv", DataFrame, decimal = ',')
println(df)
tempo_inizio = now()
...
lambda = round.( LinRange(0.7* λ_t, 1.3*λ_t,5), digits=3)
